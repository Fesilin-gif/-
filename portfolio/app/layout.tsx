 ...
 * разрешено. По этому классу CSS выбирает режим сцены, а ArchScene —
 * запускать ли отъезд камеры. Скрипт выполняется до первой отрисовки,
 * поэтому раскладка не мигает.
 */
