...
export const INTRO = {
  ...
  /** Пауза после готовности картинок, прежде чем начать влёт, мс —
   *  даёт глазу заметить арку и девушку, прежде чем начнётся
   *  движение. */
  pauseMs: 450,
} as const;
 ...
 *   арки, с отступами под надпись «Загрузка…» и кнопку «Пропустить».
 */
