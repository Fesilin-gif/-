...
/* Замена картинки (сентябрь 2026): новая фотография девушки и арки —
   тот же кадр 1122×1402, тот же проём почти пиксель в пиксель (см.
   content/opening выше, они не изменились), но стрельчатый свод у
   неё заметно более пологий — см. поправку OPENING_RECT_SAFE.y ниже. */
